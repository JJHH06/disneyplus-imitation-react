...
//aqui se utilizan svg insertados, ya que era la forma más sencilla y parecida a la página original de disney+
const NavBar = () =>{
    return (
        <div>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="nav-text-icon ">
                                    ...
                                    <a href='#' className="nav-link active">
                                            ...
                                            <span className ="text-option-navbar">Busqueda</span>
