...
const Footer = () => {
  ...
  return (
    <div className="page-footer">
        <img className='imagen-logo-footer footer-item' src= {logo}/>
        <p className='footer-item'>Politica de privacidad&nbsp;&nbsp;&nbsp;&nbsp;Acuerdo de suscripcion ayuda&nbsp;&nbsp;&nbsp;&nbsp;Dispositivos compatibles</p>
